...
> Status: Phase 6. The foundation, Console, Network, Redux, Navigation, and Performance inspectors are working. Storage and dedicated error instrumentation are scheduled for later phases.
